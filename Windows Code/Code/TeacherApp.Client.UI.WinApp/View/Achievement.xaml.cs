...
namespace TeacherApp.Client.UI.WinApp
{
    ...
    public sealed partial class Achievement : Page
    {
        ...
        private void AppHeaderImage_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            if (this.Frame != null)
            {
        ...
        private void StudentImage_Tapped(object sender, TappedRoutedEventArgs e)
        {
            if (this.Frame != null)
            {
